...
export class ActionListComponent extends BaseListComponent<MeetingRequest, MeetingResponse> implements OnInit, OnChanges {
  ...
  constructor(public meetingService: MeetingService) {
    ...
    this.meetingService.minuteOfMeetingObserver.subscribe(()=> 
    {
      this.ngOnInit();
    });
  }
