...
@Component({
  ...
  templateUrl: './submit-subtask.component.html',
  styleUrls: ['./submit-subtask.component.scss']
})
export class SubmitSubTaskComponent extends BaseAddEditComponent<TaskRequest, TaskResponse> implements OnInit{
